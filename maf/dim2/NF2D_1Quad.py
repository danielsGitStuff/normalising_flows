...
class NF2D_1Quad(VisualExample2D):
    def __init__(self):
        super().__init__("NF2D_1Quad", layers=[10, 20], layers_repeat=1)
        # self.epochs = 1
        self.vmax = 'auto'
        self.vmax = 0.02
    ...
    def create_data_distribution(self) -> Distribution:
        return WeightedMultimodalMultivariate(input_dim=2) \
            ...
            .add_d(UniformMultivariate(input_dim=2, lows=[-2, 2], highs=[2, 3]), weight=1 / 6) \
